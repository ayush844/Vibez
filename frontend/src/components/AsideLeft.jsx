        ...
        <aside className="hidden sm:block basis-1/6 lg:basis-1/5">
            ...
            <nav>
                <ul className="px-2 mr-1">
                    <li >
                        <NavLink to="/" className="flex justify-center py-4 gap-3 px-3 cursor-pointer hover:bg-slate-200 rounded-[15rem] active:bg-slate-100">
                            {({ isActive }) => 
                                isActive ? (
                                    <>
                    ...
                    <li>
                        <NavLink to="/explore" className="flex justify-center py-4 gap-3 px-3 cursor-pointer hover:bg-slate-200 rounded-[15rem] active:bg-slate-100">
                            {({ isActive }) => 
                                isActive ? (
                                    <>
                    ...
                    <li>
                        <NavLink to="/bookmarks" className="flex justify-center py-4 gap-3 px-3 cursor-pointer hover:bg-slate-200 rounded-[15rem] active:bg-slate-100">
                            {({ isActive }) => 
                                isActive ? (
                                    <>
                    ...
                    <li>
                        <NavLink to={`/profile`} className="flex justify-center py-4 gap-3 px-3 cursor-pointer hover:bg-slate-200 rounded-[15rem] active:bg-slate-100">
                            {({ isActive }) => 
                                isActive ? (
                                    <>
